# Building RingCentral automations using Zapier

Zapier allows you to automate workflows by connecting different apps and services. When integrated with RingCentral, you can automate tasks such as sending SMS messages, logging call recordings, and scheduling video meetings without manual intervention. This guide will help you understand the features, triggers, and actions available when using RingCentral with Zapier.
